...
# Import only what exists in the original utils.py first
from utils import (
    get_synthetic_user,
    ...
    # Only import these after adding them to utils.py
    extract_main_keywords,
    fetch_image_for_keyword,
    # Error classes - only import after adding to utils.py
