...
def initialize_app():
    ...
    try:
        ...
        # Initialize ChromaDB
        ASTRA_TOKEN = st.secrets.get("ASTRA_TOKEN", "")
        ASTRA_API_ENDPOINT = st.secrets.get("ASTRA_API_ENDPOINT", "")
        chroma_manager = AstraManager(token=ASTRA_TOKEN, api_endpoint=ASTRA_API_ENDPOINT)
